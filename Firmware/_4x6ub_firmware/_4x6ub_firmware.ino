...
long bandStart[11] = { 5000000,  1500000, 2000000, 5000000, 6000000,  9000000, 13000000, 17000000, 20000000, 24000000, 28000000 };
long bandStop[11]  = { 30000000, 2300000, 5000000, 6000000, 8000000, 11000000, 16000000, 19000000, 23000000, 26000000, 30000000 };
String bandMenu[11] =  {"Full Range", "160m / 1.8MHz", "80m / 3.5MHz", "60m / 5MHz", "40m / 7MHz", "30m / 9MHz", "20m / 14MHz", "17m / 17MHz", "15m / 20MHz", "12m / 24MHz", "10m / 28MHz" }; 
